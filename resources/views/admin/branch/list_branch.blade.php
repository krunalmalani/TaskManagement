@extends('layouts.master', ['title' => 'Branch Management'])
@section('css')
@endsection
@section('content')
<!-- Start Content -->
<div class="content pb-0">
    ...
    <div class="card border-0 rounded-0">
        <div class="card-header d-flex align-items-center justify-content-between gap-2 flex-wrap">
            ...
            <a href="javascript:void(0);" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add_role"><i class="ti ti-square-rounded-plus-filled me-1"></i>Add New Branch</a>
        </div>
        <div class="card-body">
