                                        ...
                                        <div class="theme-layout">
                                            ...
                                            <label for="defaultLayout">
                                                <span class="d-block mb-2 layout-img">
                                                    ...
                                                    <img src="${appAsset}assets/img/theme/default.svg" alt="img">
                                                </span>                                     
                                    ...
                                    <div class="col-4">
                                        <div class="theme-layout">
                                            ...
                                            <label for="miniLayout">
                                                <span class="d-block mb-2 layout-img">
                                                <span class="theme-check rounded-circle"><i class="ti ti-check"></i></span>
                                                    <img src="${appAsset}assets/img/theme/mini.svg" alt="img">
                                                </span>                                    
                                    ...
                                    <div class="col-4">
                                        <div class="theme-layout">
                                            ...
                                            <label for="hiddenLayout">
                                                <span class="d-block mb-2 layout-img">
                                                <span class="theme-check rounded-circle"><i class="ti ti-check"></i></span>
                                                    <img src="${appAsset}assets/img/theme/full-width.svg" alt="img">
                                                </span>                                    
