...
?>
@extends('layouts.master', ['title' => 'Super Admin Dashboard'])
@section('css')
@endsection
@section('content')
    <div class="content pb-0">
        ...
        <div class="welcome-wrap mb-4">
            <div class=" d-flex align-items-center justify-content-between flex-wrap gap-3 bg-dark rounded p-4">
                <div>
                    <h2 class="mb-1 text-white fs-24">Welcome Back, <span id="userName">{{ $userData['full_name'] ?? 'User' }}</span></h2>
                    ...
                    <div class="card-body pb-2">
                        ...
                        <div class="d-sm-flex justify-content-between flex-wrap mb-4">
                            ...
                            <div class="text-sm-end mb-0">
                                ...
                                <h6 class="fw-normal text-truncate mb-0 fs-14"><a href="https://crms.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6200000522071a030f120e074c010d0f">[email&#160;protected]</a></h6>
                            </div>
                        </div>
                        ...
                        <div class="d-sm-flex justify-content-between flex-wrap mb-4">
                            ...
                            <div class="text-sm-end mb-0">
                                ...
                                <h6 class="fw-normal text-truncate mb-0 fs-14"><a href="https://crms.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="ec8f9f8fac89948d819c8089c28f8381">[email&#160;protected]</a></h6>
                            </div>
                        </div>
                        ...
                        <div class="d-sm-flex justify-content-between flex-wrap mb-4">
                            ...
                            <div class="text-sm-end mb-0">
                                ...
                                <h6 class="fw-normal text-truncate mb-0 fs-14"><a href="https://crms.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="355d4375504d54584559501b565a58">[email&#160;protected]</a></h6>
                            </div>
                        </div>
                        ...
                        <div class="d-sm-flex justify-content-between flex-wrap mb-4">
                            ...
                            <div class="text-sm-end mb-0">
                                ...
                                <h6 class="fw-normal text-truncate mb-0 fs-14"><a href="https://crms.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="a5c2c2c9e5c0ddc4c8d5c9c08bc6cac8">[email&#160;protected]</a></h6>
                            </div>
                        </div>
                        ...
                        <div class="d-sm-flex justify-content-between flex-wrap mb-0">
                            ...
                            <div class="text-sm-end mb-0">
                                ...
                                <h6 class="fw-normal text-truncate mb-0 fs-14"><a href="https://crms.dreamstechnologies.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="4b393c0b2e332a263b272e65282426">[email&#160;protected]</a></h6>
                            </div>
                        </div>
                    </div>
                </div>
